...
export class ApiProxyService extends Service implements ApiProxy {
  ...
  static Config: z<Config> = z.object({
    ...
    workflowChangeQueueMaxSessions: z.natural().min(1)
      .default(DEFAULT_WORKFLOW_CHANGE_QUEUE_MAX_SESSIONS),
  })
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const api = createApiProxy(ctx, {
      ...
      ...(config.workflowChangeQueueMaxSessions === undefined
        ? {}
        : { workflowChangeQueueMaxSessions: config.workflowChangeQueueMaxSessions }),
    })

...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  workflowRunRecorder: 'workflow.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  workflowRuns: 'client-side workflow run controller — packages/client/runtime/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SupervisedWorkflowRunId: 'workflow.md',
  WorkflowGateId: 'workflow.md',
  WorkflowStartRequest: 'workflow.md',
  WorkflowJournalEntry: 'workflow.md',
  WorkflowDefinitionSummaryView: 'workflow.md',
  WorkflowGateRequest: 'workflow.md',
  WorkflowRunRecordingSnapshot: 'workflow.md',
  SupervisedWorkflowMemberLifecycleInfo: 'workflow.md',
  SupervisedWorkflowRunInfo: 'workflow.md',
  SupervisedWorkflowResultInfo: 'workflow.md',
  WorkflowRunHead: 'workflow.md',
  WorkflowRunListPage: 'workflow.md',
  WorkflowRunListRequest: 'workflow.md',
  WorkflowRunDetail: 'workflow.md',
  WorkflowRunRequest: 'workflow.md',
  WorkflowRunMemberDetail: 'workflow.md',
  WorkflowRunMemberPage: 'workflow.md',
  WorkflowRunMemberRequest: 'workflow.md',
  WorkflowRunMembersRequest: 'workflow.md',
  WorkflowRunLogPage: 'workflow.md',
  WorkflowRunLogsRequest: 'workflow.md',
  WorkflowRunResultView: 'workflow.md',
  WorkflowRunArtifactChunk: 'workflow.md',
  WorkflowRunArtifactPage: 'workflow.md',
  WorkflowRunArtifactRequest: 'workflow.md',
  WorkflowRunArtifactsRequest: 'workflow.md',
  WorkflowRunControlRequest: 'workflow.md',
  WorkflowRunControlResult: 'workflow.md',
  WorkflowRunAvailableValue: 'workflow.md',
  WorkflowRunValueView: 'workflow.md',
  WorkflowRunChange: 'workflow.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  WorkflowDefinitionEnvelope: 'saved-definition write contract is owned by packages/workflow/workflow-registry/README.md',
  ...
  WorkflowSaveOptions: 'saved-definition write options are owned by packages/workflow/workflow-registry/README.md',
